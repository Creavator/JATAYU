  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
      <div className="bg-gray-800 p-4 rounded-lg">
        ...
        <div className="text-3xl font-bold text-white">{user.socialCreditScore}</div>
      ...
      <div className="bg-gray-800 p-4 rounded-lg">
        ...
        <div className="text-3xl font-bold text-white">{user.tokens}</div>
      ...
      <div className="bg-gray-800 p-4 rounded-lg">
        ...
        <div className="text-3xl font-bold text-white">{user.protestsParticipated}</div>
