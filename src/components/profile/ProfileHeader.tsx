      ...
      <div className="flex-1 text-center md:text-left">
        ...
        <div className="flex items-center justify-center md:justify-start gap-6 mb-4">
          <div className="text-center">
            ...
            <span className="text-white text-sm block">Posts</span>
          </div>
          <div className="text-center">
            <span className="font-bold text-white">{user.followers.toLocaleString()}</span>
            <span className="text-white text-sm block">Followers</span>
          </div>
          <div className="text-center">
            <span className="font-bold text-white">{user.following.toLocaleString()}</span>
            <span className="text-white text-sm block">Following</span>
          </div>
          <div className="text-center">
            <span className="font-bold text-white">{user.protestsParticipated}</span>
            <span className="text-white text-sm block">Protests</span>
          </div>
        </div>
